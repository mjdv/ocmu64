...
\cref{rem:strongest}). This generalizes \cite[RR3]{dujmovic_2008}.
...
that generalizes \cite[RRLO2]{dujmovic_2008}.
...
Let us also mention this gluing-like reduction: \emph{gluing to the front} \cite[RRLO1]{dujmovic_2008}
