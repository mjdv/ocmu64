...
is a \emph{fixed} pair. The following result is well known \cite[Fact 4]{dujmovic_2004}.
...
\begin{description}
  \item[Graph simplification] We drop degree-$0$ vertices, merge identical
    ...
    slices and optimally insert them \cite{makinen_experiments,eades_heuristcis}, and re-label all nodes accordingly to make
